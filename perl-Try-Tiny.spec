...
%prep
%setup -q -n Try-Tiny-0.32
cd %{_builddir}/Try-Tiny-0.32
pushd ..
cp -a Try-Tiny-0.32 buildavx2
popd
...
cp %{_builddir}/Try-Tiny-%{version}/LICENCE %{buildroot}/usr/share/package-licenses/perl-Try-Tiny/7e8e33f9e95ab89effb710036a61ace6a226a6c0 || :
if test -f Makefile.PL; then
